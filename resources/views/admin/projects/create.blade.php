    ...
    >
      ...
      <div class="allPhotosInputsContainers">
        <div class="miniParagraphContainer">
          ...
          <label class="fileSquare" id="coverPreviewBox">
            <input class="photoInput" type="file" name="cover_image" id="cover_image_input" accept="image/*" required>
            <img class="coverPreview" id="coverPreview" alt="Cover preview">
      ...
      <div class="writtenContainer">
        <div class="allPhotosInputsContainers">
          <div class="miniParagraphContainer">
            ...
            <div>
              <input class="writPlaHold" name="title" placeholder="TITLE" value="{{ old('title') }}">
            </div>
            
            
            <div>
              <input class="writPlaHold" name="place" placeholder="PLACE" value="{{ old('place') }}">
            </div>
            
            <div>
              <input class="writPlaHold" name="date" placeholder="DATE" value="{{ old('date') }}">
            </div>
          </div>
